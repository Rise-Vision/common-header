  ...
  function ($scope, $modalInstance, $log, $modal, $templateCache, $loading, planFactory, currentPlan,
    ...
    $scope.canStartTrial = function (plan) {
      ...
      if (currentPlan.type === plan.type) {
        ...
        allPlansMap[plan.productCode].trialPeriod > 0) {
