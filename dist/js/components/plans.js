...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('plans/checkout-review-purchase.html',
    '<div id="content-five" class="prototype-show" style="display: none;"><div class="row"><div class="col-md-6 u_padding-md-vertical"><p class="lead">Company Account</p><div class="text-block"><b>Acme Co Inc.</b><br>Email: user@domain.com<br>Company ID: ce4684a1-e8b3-4e02-9798-c4517b43cf7a</div></div><div class="col-md-6 u_padding-md-vertical"><p class="lead">Payment Method <button class="btn btn-xs btn-white">Edit</button></p><div class="text-block">VISA<br>4242-0000-4242-0000<br>Exp: 07/18</div></div></div><div class="row"><div class="col-md-6 u_padding-md-vertical"><p class="lead">Billing Address <button class="btn btn-xs btn-white">Edit</button></p><div class="text-block">Gob Bluth<br>user@risevision.com<br>Rise Vision Inc.<br>545 King Street West<br>Toronto, ON, M5V 1M1<br>Canada</div></div><div class="col-md-6 u_padding-md-vertical"><p class="lead">Shipping Address <button class="btn btn-xs btn-white">Edit</button></p><div class="text-block">Rise Vision Inc.<br>545 King Street West<br>Toronto, ON, M5V 1M1<br>Canada</div></div></div><hr style="margin-top: 5px; margin-bottom: 5px;"><div class="row"><div class="col-xs-12"><p class="lead">Subscription Details <button class="btn btn-xs btn-white">Edit</button></p></div></div><div class="row"><div class="col-xs-5"></div><div class="col-xs-4 text-right text-block"><p>Basic Plan (Yearly)<br>2 Additional Displays<br>GST<br>PST<br>Total Tax:</p><span class="order-total">Order Total:</span></div><div class="col-xs-3 text-right text-block"><p>$85<br>$19<br>$1.70<br>$2.20<br>$4.70</p><span class="order-total">$122.34 <small class="u_margin-left">CAD</small></span></div></div><div class="row"><hr></div><div class="col-xs-12 text-center"><button id="" class="btn btn-primary btn-hg">Pay $122.34 Now</button><br><small><i class="fa fa-plus"></i><i class="fa fa-plus"></i>Secure Checkout from Chargebee and Stripe</small></div></div>');
}]);
})();
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('plans/plans-modal.html',
    ...
    '      color: #5b5b5b;\n' +
    '    }\n' +
    '</style><div id="checkout-modal" class="modal-body u_padding-lg" stop-event="touchend"><div class="app-launcher-wizard_progress-bar hidden-sm hidden-xs" style="padding-top: 32px;"><div id="step-one" class="progress-bar-step progress-bar-step--active"><p>Subscription Details</p></div><div id="step-two" class="progress-bar-step"><p>Billing Address</p></div><div id="step-three" class="progress-bar-step"><p>Shipping Address</p></div><div id="step-four" class="progress-bar-step"><p>Payment Method</p></div><div id="step-five" class="progress-bar-step"><p>Purchase Review</p></div></div><div ng-include="\'plans/checkout-subscriptions.html\'"></div><div ng-include="\'plans/checkout-billing-address.html\'"></div><div ng-include="\'plans/checkout-billing-address-error.html\'"></div><div ng-include="\'plans/checkout-shipping-address.html\'"></div><div ng-include="\'plans/checkout-payment-methods.html\'"></div><div ng-include="\'plans/checkout-review-purchase.html\'"></div></div><div class="modal-footer"></div><script>\n' +
    '  //SETUP\n' +
    ...
    '  });\n' +
    ' \n' +
    '//SHOW ERROR STATE content-two-error\n' +
