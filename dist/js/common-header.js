...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('auth-buttons.html',
    ...
    '});\n' +
    '//DOWNGRADE\n' +
    '$(document).on("click", "#downgradePlan", function() {\n' +
    '  \n' +
    '});\n' +
    '\n' +
    '  </script>');
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('plans-dowgrade-modal.html',
    '<div id="companyIcpModal"><div class="modal-header"><button type="button" class="close" ng-click="dismiss()" aria-hidden="true"><i class="fa fa-times"></i></button><h3 id="icpModalTitle" class="modal-title">Downgrade</h3></div><div class="modal-body u_padding-lg" style="padding-top: 0" stop-event="touchend"><div class="container-fluid"></div></div><div class="modal-footer"></div></div>');
}]);
})();
