...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('auth-buttons.html',
    ...
    '$(document).ready(function() { \n' +
    '  // alert(\'dd\');\n' +
    '  $("#plansDowngradeModal").css(\'display\' , \'none\');\n' +
    '  $("#plansDowngradeModal").css(\'position\' , \'fixed\');\n' +
    '  $("#plansDowngradeModal").css(\'top\' , \'20px\');\n' +
    '  $("#plansDowngradeModal").css(\'left\' , \'40%\');\n' +
    '  $("#plansDowngradeModal").css(\'border\' , \'1px solid #636262\');\n' +
    '  $("#plansDowngradeModal").css(\'z-index\' , \'999999\');\n' +
    '  $("#plansDowngradeModal").css(\'border-radius\' , \'4px\');\n' +
    '  $("#plansDowngradeModal").css(\'background-color\' , \'white\');\n' +
    '  $("#plansDowngradeModal").css(\'width\' , \'500px\');\n' +
    '});\n' +
    '\n' +
    '//SHOW DOWNGRADE MODAL\n' +
    '$(document).on("click", "#showDowngradeModal", function() {\n' +
    '  $("#plansDowngradeModal").css(\'display\' , \'block\' );\n' +
    '});\n' +
    '\n' +
    '//SHOW DOWNGRADE MODAL\n' +
    '$(document).on("click", "#hideDowngradeModal", function() {\n' +
    '  $("#plansDowngradeModal").css(\'display\' , \'none\' );\n' +
    '});\n' +
    '  </script>');
}]);
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('plan-downgrade-note-modal.html',
    '<div id="plansDowngradeModal"><div class="modal-header"><button id="sendUsANoteModalCloseButton" ng-click="dismiss()" type="button" class="close"><i class="fa fa-times"></i></button><h2 class="modal-title">Downnn</h2></div><div class="modal-body text-center" stop-event="touchend">Downnn</div></div>');
}]);
})();
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('plans-dowgrade-modal.html',
    '');
}]);
})();
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('plans-modal-2.html',
    '<div id="plansPopupContent"><div class="modal-header"><button type="button" class="close" ng-click="dismiss()" aria-hidden="true"><i class="fa fa-times"></i></button><h3 id="" class="modal-title">Choose Your Plan</h3></div><div class="modal-body u_padding-lg" stop-event="touchend"><div id="" class="grid-list row"><div class="col-xs-12 col-sm-6 col-md-3 ng-scope"><div class="panel panel-default"><div itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><div class="grid-list-text text-center"><h4 id="productName">Free</h4><p class="product-description">Get Rise Storage, Embedded Presentations, and Template Library for one great price.</p><div><h1>$0</h1>&nbsp;per Company per Month</div><a class="cta_button btn btn-default u_margin-lg" id="showDowngradeModal">Downgrade</a></div></div></div></div><div class="col-xs-12 col-sm-6 col-md-3 ng-scope"><div class="panel panel-default"><div itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><div class="grid-list-text text-center"><h4 id="productName">Basic Plan</h4><p class="product-description">Get Rise Storage, Embedded Presentations, and Template Library for one great price.</p><div><h1>$19</h1>&nbsp;per Company per Month</div><a target="_blank" class="cta_button btn btn-white u_margin-lg" title="">Current</a></div></div></div></div><div class="col-xs-12 col-sm-6 col-md-3 ng-scope"><div class="panel panel-default"><div itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><div class="grid-list-text text-center"><h4 id="productName">Advanced Plan</h4><p class="product-description">Get Rise Storage, Embedded Presentations, and Template Library for one great price.</p><div><h1>$85</h1>&nbsp;per Company per Month</div><a target="_blank" href="https://store.risevision.com/product/290/advanced-plan" class="cta_button btn btn-primary u_margin-lg" title="">Subscribe</a></div></div></div></div><div class="col-xs-12 col-sm-6 col-md-3 ng-scope"><div class="panel panel-default"><div itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><div class="grid-list-text text-center"><h4 id="productName">Enterprise Plan</h4><p class="product-description">Get Rise Storage, Embedded Presentations, and Template Library for one great price.</p><div><h1>$489</h1>&nbsp;per Company per Month</div><a target="_blank" href="https://www.risevision.com/contact-us" class="cta_button btn btn-primary u_margin-lg" title="">Contact Us</a></div></div></div></div></div><div id="plansDowngradeModal" style="display:none; position: fixed; top: 80px; left: 28%; border: 1px solid #636262; z-index: 999999979; border-radius: 4px; background-color: white; width: 500px;"><div class="modal-header"><button type="button" class="close" id="hideDowngradeModal" aria-hidden="true"><i class="fa fa-times"></i></button><h3 id="icpModalTitle" class="modal-title">Downgrade</h3></div><div class="modal-body u_padding-lg" stop-event="touchend"><div class="container-fluid text-center u_padding-lg">Downgrading an account needs to be processed through our Support team. Please reach out and we\'ll help!<br><button class="btn btn-primary btn-lg u_margin-lg-top" ng-click="getSupport()">Contact Support</button></div></div><div class="modal-footer"></div></div><div class="text-center u_margin-md-top"><a class="btn btn-white btn-lg get-started-guide" target="_blank" href="https://www.risevision.com/pricing">Learn More About Our Plan Pricing</a></div></div><div class="modal-footer"></div></div>');
}]);
})();
